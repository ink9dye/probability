...
#
# from core.handlers import save_file
...
#     :param data_type: 数据类型 ('deck' / 'condition' / 'ydk')
#     :param data: 数据内容
#     :param titles: 标题行（可选）
#     """
#     save_file(file_path, data_type, data, titles)
#
#
# def export_data(file_name: str, data_type: str, data, titles: list = None, *subdirs) -> str:
#     """
#     统一导出入口。用于导出 deck/condition/ydk 数据。
#     """
#     if not subdirs:
#         if data_type == "deck":
...
#         else:
#             full_path = resolve_path("data", "output", file_name)
#     else:
#         full_path = resolve_path(*subdirs, file_name)
#
#     save_data(full_path, data_type, data, titles)
